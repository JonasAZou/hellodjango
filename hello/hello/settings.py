...
DATABASES = {
    'default': {
        ...
        'NAME': 'hello.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'n2g^#sfleqbeq5#qo#9i6e1!h3709=u3)xcs3^23*_mb_8y%)r'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/home/xu/github/hellodjango/hello/tpls',
)
